 ...
 * 1) First create a WaypointCircuit
 * 2) Assign the BetterWaypointFollower.cs script to a GameObject that will follow the circuit
 * 3) Drag the Circuit GameObject to the Follower script in the Inspector
 **/
